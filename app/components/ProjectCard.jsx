...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <Card className="rounded-xl p-2 border border-zinc-700 bg-zinc-900">
      <CardHeader className="h-52 md:h-72 rounded-t-xl relative group" style={{ background: `url(${imgUrl})`, backgroundSize: "cover" }}>
      ...
      <CardBody className="text-white rounded-b-xl mt-3  py-6 px-4">

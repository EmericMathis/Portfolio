...
export default function HeroCards() {
    const activities = [
        ...
        {
            title: "Qui suis-je ?",
            description: "J'ai 33 ans, un parcours atypique de reconversion qui me donne des compétences supplémentaires, comme la gestion de projet, le service client, et bien d'autres.",
            icon: User
        },
        {
            title: "DevOps",

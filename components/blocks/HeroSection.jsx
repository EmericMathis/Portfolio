        ...
        <section className='pt-2'>
            <div className='grid grid-cols-1'>
                <div className='col-span-7 place-self-center text-center md:text-left'>
                    <h1 className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-4xl lg:text-7xl font-sans py-2 md:py-10 font-bold tracking-tight">
                        <span className='text-primary bg-clip-text'>{helloText[0]}</span>
                        <br />
                        <TypeAnimation cursor={false} sequence={['Emeric', 3000, helloText[1], 3000, helloText[2], 3000, 'UI/UX Designer', 3000]} wrapper="span" speed={40} repeat={Infinity} style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '100%' }} />
